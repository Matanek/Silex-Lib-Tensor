...
| `optimizer_sgd_state` | optimizer | `float32` | tolerated | pytorch | abs 2e-06, rel 2e-06 |
| `optimizer_adam_state` | optimizer | `float32` | tolerated | pytorch | abs 3e-06, rel 3e-06 |
| `optimizer_clip_global_norm` | optimizer | `float32` | tolerated | pytorch | abs 2e-06, rel 2e-06 |

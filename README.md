...
placement, lossless transfers, shared shape views, typed indexing, and ordered
`float32` scalar compute. Automatic differentiation and neural-network packages
